    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <form onSubmit={handlePasswordChange} className="card space-y-4 p-6">
        ...
        <div>
          ...
          <input type="password" required className="input" value={passwords.current_password} onChange={updatePw("current_password")} />
        </div>
        <div>
          <label className="label">New password</label>
          <input type="password" required minLength={8} className="input" value={passwords.new_password} onChange={updatePw("new_password")} />
        </div>
